...
body {
	...
	<div class="square">
		<a href="http://localhost/mvc/index.php?controller=view&action=university&dega_id=1">
	     <div class="content">
	        <img class="rs" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/University_of_Tirana_logo.svg/1024px-University_of_Tirana_logo.svg.png"/>
